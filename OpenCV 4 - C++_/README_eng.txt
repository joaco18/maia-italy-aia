...
underlying harware/software platform.
--------------------------------------------------------------------
...
-  Visual Studio 2012 installed and tested (run an "Hello World")
-  AIA template project (should be within this folder)
--------------------------------------------------------------------
Procedure:

0. Be 101% sure you meet all the requirements state above. If you do
