...
{
    cv::Mat img;
    std::string win_name = "Gradient edge detection";
    int grad_mag_thresh = 50;

    void gradientEdgeDetection(int, void*)
    {
        cv::Mat dx, dy;
...
int main()
{
    ...
    cv::createTrackbar("grad_mag_thresh", win_name, &grad_mag_thresh, 100, gradientEdgeDetection);
